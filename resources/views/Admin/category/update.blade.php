    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class='card-heading p-1 pl-3'>Update Category</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('admin.category.update', [$data->id])}}" enctype="multipart/form-data">
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" class="form-control" value="{{$data->name}}" id="basicInput" placeholder="Enter name" name="name" required>
                                </div>
